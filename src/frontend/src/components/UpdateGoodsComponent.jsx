...
class UpdateGoodsComponent extends Component {
    ...
    updateGoods=(e)=>{
        ...
        console.log('goods=>' + JSON.stringify(gds) + " id : "+this.state.id);

        GoodsService.updateGoods(this.state.id, gds)
        .then( res => {
                ...
                <div className="container">
                    <div className="row">
                        <div className="card col-md-6 offset-md-3 offset-md-3">
                            <h3 className="text-center">UPDATE GOODS</h3>
                            <div class="card-body">
                                <form>
                                    ...
                                    <button className="btn btn-success" onClick={this.updateGoods}>SAVE</button>
